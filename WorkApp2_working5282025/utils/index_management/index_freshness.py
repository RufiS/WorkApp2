...
def is_index_fresh(index_path: Optional[str] = None, last_known_mtime: float = 0) -> Tuple[bool, float]:
    """
    ...
    if not is_fresh:
        logger.info(f"Index has been modified since last load (mtime: {current_mtime} vs {last_known_mtime})")
